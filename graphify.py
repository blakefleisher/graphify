...
for line in datalines:
	...
	if len(line) == 0:
		continue
	elif line[:13] == "%% discipline": #Special word commented out in latex
		Values['discipline'] = line[13:].strip()
		#currentDiscipline = line[13:].strip()
	elif line[0] != "%":
		line = line.split("%",1)[0] #Sort of like a strip
	if line[0:11] == "\\newcommand":
		pieces = line.split("{")
		...
		print(variable1, variable2) # Check later if not working
	elif line[0:5] == "\\rput":
